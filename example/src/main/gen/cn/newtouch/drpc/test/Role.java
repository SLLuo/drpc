...
public class Role implements org.apache.thrift.TBase<Role, Role._Fields>, java.io.Serializable, Cloneable, Comparable<Role> {
  ...
  private static final org.apache.thrift.protocol.TField PERMS_FIELD_DESC = new org.apache.thrift.protocol.TField("perms", org.apache.thrift.protocol.TType.LIST, (short)2);
  ...
  private List<Perm> perms; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.PERMS, new org.apache.thrift.meta_data.FieldMetaData("perms", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, Perm.class))));
  ...
  public Role(Role other) {
    ...
    if (other.isSetPerms()) {
      List<Perm> __this__perms = new ArrayList<Perm>(other.perms.size());
      for (Perm other_element : other.perms) {
        __this__perms.add(new Perm(other_element));
      }
  ...
  public java.util.Iterator<Perm> getPermsIterator() {
    return (this.perms == null) ? null : this.perms.iterator();
  }

  public void addToPerms(Perm elem) {
    if (this.perms == null) {
      this.perms = new ArrayList<Perm>();
    }
    this.perms.add(elem);
  }
  ...
  public Role setPerms(List<Perm> perms) {
    this.perms = perms;
    return this;
  }
  ...
  public int hashCode() {
    ...
    boolean present_perms = true && (isSetPerms());
    list.add(present_perms);
    if (present_perms)
      list.add(perms);
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (perms == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'perms' was not present! Struct: " + toString());
    }
  ...
  private static class RoleStandardScheme extends StandardScheme<Role> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.perms = new ArrayList<Perm>(_list10.size);
                Perm _elem11;
                for (int _i12 = 0; _i12 < _list10.size; ++_i12)
                {
                  _elem11 = new Perm();
                  _elem11.read(iprot);
                  struct.perms.add(_elem11);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Role struct) throws org.apache.thrift.TException {
      ...
      if (struct.perms != null) {
        ...
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.perms.size()));
          for (Perm _iter13 : struct.perms)
          {
            _iter13.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class RoleTupleScheme extends TupleScheme<Role> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, Role struct) throws org.apache.thrift.TException {
      ...
      struct.setNameIsSet(true);
      {
        ...
        struct.perms = new ArrayList<Perm>(_list15.size);
        Perm _elem16;
        for (int _i17 = 0; _i17 < _list15.size; ++_i17)
        {
          _elem16 = new Perm();
          _elem16.read(iprot);
          struct.perms.add(_elem16);
        }
      }
      struct.setPermsIsSet(true);
    }
